...
public class SignUpPage extends JFrame {
    ...
    public SignUpPage() {
        ...
        signUpContainer.setBorder(new EmptyBorder(40, 60, 50, 60));
        ...
        try {
            ...
            signUpContainer.add(fallback);
        }

        signUpContainer.add(Box.createVerticalStrut(50));
        ...
        signUpContainer.add(formPanel);
        signUpContainer.add(Box.createVerticalStrut(40));
