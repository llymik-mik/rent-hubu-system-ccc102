    ...
    public class DashboardPage extends JFrame {
        ...
        private JScrollPane buildItemsPanel() {
            // 1. Create the panel that holds the actual cards
            ...
            for (String[] item : items) {
                ...
                grid.add(card); // Add card to grid (OK)
            }
            ...
            // IMPORTANT: Only add the 'grid' to the 'centeringWrapper'
            centeringWrapper.add(grid);
    
            // 3. Create the ScrollPane and give it the wrapper
            ...
            return scroll; // Return the scroll pane to buildMainPanel()
        }
        ...
        private JPanel createItemCard(String name, String owner, String status, String tags) {
            ...
            imgBox.setPreferredSize(new Dimension(0
                    , 150));
            ...
            // Request button — opens RequestItemPage with this card's data
            ...
            reqBtn.addActionListener(e ->
                    new RequestItemPage(studentName, name, owner, status, tags));
            card.add(reqBtn);
